...
def menu():
    ...
    print '\x1b[1;37;40m1. Cek Info Akun Orang Lain'
            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://www.instagram.com/_zhlnt_')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
